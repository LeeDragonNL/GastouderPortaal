...
public class StepperController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        loginField.getValidator().constraint("Gebruikersnamen moeten minimaal 6 tekens bevatten", loginField.textProperty().length().greaterThanOrEqualTo(6));
        ...
        firstNameField.setPromptText("Bedrijf Naam..");
